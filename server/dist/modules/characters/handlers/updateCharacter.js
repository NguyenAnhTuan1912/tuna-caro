...
const UpdateCharacterHandler = (0, handler_1.createHandler)("/", function ({ DBs, Utils }) {
  return function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        let result = yield DBs.CaroGameDB.Character.updateCharacter({ id }, data);
        if ("$$error" in result) {
          statusCode = 400;
          throw new Error(result.$$error);
        }
        ;
        return Utils.RM.responseJSON(res, 200, Utils.RM.getResponseMessage(false, result, "Character is updated successfully."));
      }
      catch (error) {
...
exports.default = UpdateCharacterHandler;